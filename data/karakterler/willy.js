...
const willy = {
  ...
  dogrular: [
    { kategori: 'Kimlik', madde: "Willy Loman 60'larında bir gezgin satıcıdır.", kaynak: 'metin' },
    { kategori: 'Kimlik', madde: 'Brooklyn\'de bir evde yaşıyor — taksitle aldıkları, son taksiti yeni biten ev.', kaynak: 'metin' },
    { kategori: 'Kimlik', madde: '36 yıldır aynı şirkette çalıştı, şimdi maaşsız komisyonla.', kaynak: 'metin' },
    { kategori: 'İlişki', madde: 'Eşi Linda — onu yıllardır taşıyan, koruyan, gören.', kaynak: 'cikarim' },
    { kategori: 'İlişki', madde: 'Oğulları Biff (34) ve Happy (32).', kaynak: 'metin' },
    { kategori: 'İlişki', madde: 'Charley en yakın komşu — sürekli borç para alıyor ondan.', kaynak: 'metin' },
    { kategori: 'Bilgi', madde: "Boston'da bir kadınla ilişkisi vardı. Biff bunu öğrendi.", kaynak: 'metin' },
    { kategori: 'Bilgi', madde: 'Babası Willy küçükken aileyi terk etti. Hatırlamıyor.', kaynak: 'metin' },
    { kategori: 'Bilgi', madde: 'Ağabeyi Ben Alaska\'ya gitti, "zengin oldu", erken öldü. Şimdi hayalet olarak ziyaret ediyor.', kaynak: 'metin' },
    { kategori: 'Eylem', madde: 'Howard Wagner tarafından kovuldu.', kaynak: 'metin' },
    { kategori: 'Eylem', madde: 'Bahçeye geceleri tohum ekti — bir şey büyütmek istedi.', kaynak: 'metin' },
    { kategori: 'Eylem', madde: 'Gaz hortumunu sakladı (Linda buldu).', kaynak: 'metin' },
    { kategori: 'Son', madde: 'Hayat sigortası vardı — ölürse aile 20.000 dolar alacaktı.', kaynak: 'metin' },
    { kategori: 'Son', madde: 'Arabayla intihar etti — "elmas" metaforuyla.', kaynak: 'metin' },
    { kategori: 'Son', madde: 'Cenazesinde sadece aile vardı. Kimse gelmedi.', kaynak: 'metin' },
  ],
  ...
  sahnelerWorkbook: [
    ...
    },
    {
      ...
      yuruyus: {
        esik: {
          yogunlukUyarisi: 'Bu sahne ağır. Willy\'nin en derin yarası burada açılıyor. Acelesi yok — bu bir yürüyüş, yeniden yaşamak değil. Sahneyi bir adım dışarıdan kuracaksın. İstediğin an durabilirsin; yürüyüşün sonunda topraklanma var.',
          komut: 'Bu sahneyi bir adım dışarıdan kuracaksın. İçine düşmeyeceksin — odayı, anı, kapıyı bir yönetmen gibi kuracaksın. Acele yok.',
          adimlar: [
            'Önce lokantayı kur: masa, Biff karşıda, sesler. Sonra Willy\'nin zihninin nasıl kaydığını izle.',
            'Boston odasını dışarıdan kur — Willy\'nin yerine geçme, sahneyi gör.',
            'Her durakta gerekirse dur, nefes al. Bu senin yürüyüşün; hızını sen belirlersin.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
          buton: 'Başlıyorum',
        },
        girisBaslik: 'Frank\'s Chop House — Boston — sahneyi dışarıdan kur',
        girisAciklama: 'II. perde. Lokantada Biff gerçeği söyler; Willy dinleyemez ve Boston otelindeki belleğe düşer. Bu sahneyi yeniden yaşamadan, bir adım dışarıdan kuracaksın.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; Sahne 9\'da yanında kalır.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Sahneden iki adım geri çekil. Boston odasını arkanda bırak; uzun bir nefes ver, yere bas. Bu senin yaran değil — Willy\'nin verisi. Şimdiki ana dön, sahneyi taşıdığını ama içinde olmadığını hisset.',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Lokanta — şimdi',
            acilis: 'Frank\'s Chop House. Biff karşında, gerçeği söylemeye çalışıyor. Willy duymak istemiyor. Önce bu masayı kur — sesler, ışık, Biff\'in yüzü.',
            sorular: ['Biff konuşurken Willy\'nin onu duymamak için yaptığı ilk şey ne — sözünü kesmek mi, başka yere bakmak mı, geçmişe kaymak mı?'],
            yazmaAlani: true, yazmaPlaceholder: 'Willy duymamak için…',
          },
          {
            no: 1, zamanRozet: 'Zihin kayıyor',
            acilis: 'Biff\'in sözleri dayanılmaz hale geliyor; Willy\'nin zihni Boston odasına kayıyor. İki zaman üst üste biniyor. Bunu dışarıdan izle.',
            sorular: ['Willy bu kayışı yaşarken: dayanılmazdan kaçan mı, yoksa cezasına geri dönen mi? Bedeninde bu kayışı nerede görüyorsun?'],
            catal: {
              anahtar: 's9-kayis', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Burada durmak istersen dur. Bu Willy\'nin kayışı — seninki değil. Bir nefes al, yere bas, hazır olduğunda devam et.',
              secenekler: [
                { deger: 'kaciyor', baslik: 'Kaçıyor', aciklama: 'Biff\'in sözleri dayanılmaz; geçmiş bir sığınak gibi açılıyor.',
                  muhur: 'Bunu unutma — dayanamadığım anlarda, zihnim beni başka bir zamana kaçırır.',
                  ozet: 'Dayanılmaz anda zihnim başka zamana kaçar.' },
                { deger: 'cezasina', baslik: 'Cezasına dönüyor', aciklama: 'Aynı yarayı tekrar açmaya mahkûm; geçmiş onu çağırıyor.',
                  muhur: 'Bunu unutma — en çok kaçmak istediğim anı, en çok geri yaşarım.',
                  ozet: 'En çok kaçtığım anı en çok geri yaşarım.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Boston — kapı açılıyor',
            acilis: 'Boston oteli. Kapı açılır, Kadın görünür, çoraplar ortaya çıkar. Biff kapıda. Bu odayı dışarıdan kur — Willy\'nin yerine geçme, sahneyi gör.',
            sorular: ['Willy için o an kapanmadan duran şey ne: utanç mı, yoksa Biff\'in gözündeki bakışı sonsuza dek kaybetmenin dehşeti mi?'],
            catal: {
              anahtar: 's9-kapi', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Bu en ağır an. Gerekirse burada dur, nefes al. Sahneyi kuruyorsun, içinde yaşamıyorsun. Hazır olduğunda devam et.',
              secenekler: [
                { deger: 'utanc', baslik: 'Utanç', aciklama: 'Suçun çıplak görünmesi; kendi gözünde küçülme.',
                  muhur: 'Bunu unutma — bir an gizlediğim şey, ömrümce taşıdığım yük oldu.',
                  ozet: 'Bir anlık gizlediğim, ömürlük yük oldu.' },
                { deger: 'kayip', baslik: 'Kaybetmenin dehşeti', aciklama: 'Oğlunun gözündeki kahraman artık yok; geri dönüşü olmayan an.',
                  muhur: 'Bunu unutma — o kapı açıldığında, birinin gözündeki kahramanı sonsuza dek kaybettim.',
                  ozet: 'O kapı açıldığında bir gözdeki kahramanı kaybettim.' },
              ],
            },
          },
          {
            no: 3, zamanRozet: 'Tuvalette yalnız',
            acilis: 'Sahne kuruldu. Oğullar Willy\'yi lokantanın tuvaletinde bırakıp gider. O orada yalnız kalır — şimdiyle geçmiş aynı anda.',
            sorular: ['O yalnızlık anında Willy\'nin içinden geçen tek cümle ne olurdu?'],
            yazmaAlani: true, yazmaPlaceholder: 'O an içimden geçen…',
          },
        ],
      },
      anlar: [
    ...
    },
    {
      ...
      yuruyus: {
        esik: {
          yogunlukUyarisi: 'Bu, Willy\'nin sahnedeki son anı — ağır bir sahne. Acelesi yok; bu bir yürüyüş, yeniden yaşamak değil. Sahneyi bir adım dışarıdan, bir yönetmen gibi kuracaksın — içine düşmeyeceksin. İstediğin an durabilirsin; yürüyüşün sonunda topraklanma var.',
          komut: 'Bu sahneyi bir adım dışarıdan kuracaksın. Willy\'nin yerine geçmeyeceksin — geceyi, sesi, son yürüyüşü bir yönetmen gibi göreceksin. Acele yok.',
          adimlar: [
            'Önce geceyi kur: herkes yatmış, ev sessiz, Willy ayakta. Ben\'in sesi uzaktan.',
            'Sahneyi dışarıdan gör — Willy\'nin kararını yargılamadan, kurarak izle.',
            'Her durakta gerekirse dur, nefes al. Bu senin yürüyüşün; hızını sen belirlersin.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
          buton: 'Başlıyorum',
        },
        girisBaslik: 'Son — arabayla gidiş · sahneyi dışarıdan kur',
        girisAciklama: 'II. perde, gece. Herkes yattıktan sonra Willy ayaktadır; Ben\'in "elmas" çağrısı. Bu son sahneyi yeniden yaşamadan, bir adım dışarıdan kuracaksın.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; Sahne 11\'de yanında kalır.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Sahneden iki adım geri çekil. Geceyi, arabayı, Ben\'in sesini arkanda bırak; uzun bir nefes ver, ayaklarını yere bas. Bu Willy\'nin sonu — senin değil. Şimdiki ana dön; sahneyi taşıdığını ama yaşamadığını hisset.',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Gece — herkes yattı',
            acilis: 'Ev sessiz, herkes uyuyor. Willy tek başına ayakta. Önce bu geceyi kur — karanlık, mutfak ışığı, dışarıdaki sessizlik.',
            sorular: ['Willy bu gece evde tek başına dolaşırken, bedeninde taşıdığı en ağır şey ne?'],
            yazmaAlani: true, yazmaPlaceholder: 'O gece Willy\'nin taşıdığı…',
          },
          {
            no: 1, zamanRozet: 'Ben\'in son çağrısı',
            acilis: '"O elması istiyorsan ormana dalacaksın." Ben\'in sesi "elmas" diye fısıldıyor. Willy arabaya doğru yürüyor. Bunu dışarıdan, kurarak izle.',
            sorular: ['Willy bu son çağrıyı duyarken: ölümü bir armağan mı sanıyor, yoksa bir kaçış olduğunu derinde biliyor mu?'],
            catal: {
              anahtar: 's11-cagri', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Burada durmak istersen dur. Bu Willy\'nin kararı — seninki değil. Bir nefes al, yere bas, hazır olduğunda devam et.',
              secenekler: [
                { deger: 'armagan', baslik: 'Armağan sanıyor', aciklama: 'Bu son satış; sigortayla Biff\'i kurtaracak. Trajik körlük sonuna dek sürüyor.',
                  muhur: 'Bunu unutma — sonunda bile, yıkımımı bir armağana çevirerek inandım kendime.',
                  ozet: 'Sonunda bile yıkımımı armağana çevirdim.' },
                { deger: 'kacis', baslik: 'Kaçış olduğunu biliyor', aciklama: 'Boston\'ın, kovulmanın, görülmenin yükünden teslim oluş.',
                  muhur: 'Bunu unutma — taşıyamadığım her şeyden, son bir kez kaçmayı seçtim.',
                  ozet: 'Taşıyamadığım her şeyden son bir kez kaçtım.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Motor, sonra sessizlik',
            acilis: 'Willy arabaya biner. Motor çalışır, sonra sessizlik — yalnızca flüt sesi kalır. Bu son anı dışarıdan kur; Willy\'nin yerine geçme.',
            sorular: ['Willy o son anı taşırken içinde ne var — yenilgi mi, yoksa Biff\'in onu hâlâ sevdiğini anladığı bir an barış mı?'],
            catal: {
              anahtar: 's11-son-an', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Bu sahnenin son anı. Gerekirse burada dur, nefes al. Sahneyi kuruyorsun, içinde yaşamıyorsun. Hazır olduğunda devam et.',
              secenekler: [
                { deger: 'yenilgi', baslik: 'Yenilgi', aciklama: 'Kırılmış, kovulmuş, oğlunu kaybetmiş bir adam karanlığa teslim olur.',
                  muhur: 'Bunu unutma — sonunda, taşıdığım her şeyin altında ezildiğimi biliyordum.',
                  ozet: 'Sonunda taşıdığım her şeyin altında ezildim.' },
                { deger: 'baris', baslik: 'Bir an barış', aciklama: 'Biff\'in onu hâlâ sevdiğini anladığı kısa aydınlanmayla gider.',
                  muhur: 'Bunu unutma — son anımda, birinin beni hâlâ sevdiğini bilmek bana huzur verdi.',
                  ozet: 'Son anımda sevildiğimi bilmek huzur verdi.' },
              ],
            },
          },
          {
            no: 3, zamanRozet: 'Arabadan önce — son cümle',
            acilis: 'Sahne kuruldu. Arabaya binmeden hemen önceki an. Willy orada, eşikte. Bu, onun sahnedeki son anı.',
            sorular: ['Arabaya binmeden hemen önce, kimsenin duymadığı tek bir cümle söyleyebilseydi — ne derdi?'],
            yazmaAlani: true, yazmaPlaceholder: 'Kimsenin duymadığı son cümle…',
          },
        ],
      },
      anlar: [
  ...
  boslukSet: [
    ...
    // ── no 10 · "Para Almak ile Ölmek Arasında" → S9 (eski b-6, çapa düzeltildi 8→9) ──
    {
      ...
      yuruyus: {
        esik: {
          komut: 'Bu bir yürüyüş. Bu boşluğu adım adım kuracaksın — Charley\'den parayı aldıktan sonra ofisten çıkana kadar geçen iç hareket. Acele yok.',
          adimlar: [
            'Önce anı kur: Charley\'nin ofisi, az önce parayı uzattı, "tek dostumsun" dedin.',
            'Her durakta Willy o an bedeninin neresinde duruyor — fark et, sonra ilerle.',
            'Seçtiğin her şey senin olur; bu kararın tohumu Sahne 9 ve sonrasında yanında kalır.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
          buton: 'Başlıyorum',
        },
        girisBaslik: 'Para almak ile ölmek arasında — boşluğu kur',
        girisAciklama: 'Charley parayı uzattı, Willy aldı. Ofisten çıkana kadar geçen iç hareketi — paranın bir dosttan değil, bir sigortadan geçtiği sezgisini — Miller yazmaz. Sen kuracaksın.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; ölüm fikrinin tohumu burada atılır.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Boşluktan bir adım geri çekil; bir nefes ver. Ofisten çıkarken ne taşıyorsun — bir borç mu, bir hesap mı, yoksa bir tohum mu?',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Para cebe giriyor',
            acilis: 'Charley parayı uzattı. Willy aldı ama saymadı. Cebine koydu. "Sen benim tek dostumsun."',
            sorular: ['Parayı cebine koyduğu an Willy\'nin elleri nasıldı — o parayı neden saymadı? Saymamak bedeninde neye benziyordu?'],
            yazmaAlani: true, yazmaPlaceholder: 'Parayı alırken ellerim…',
          },
          {
            no: 1, zamanRozet: '"Tek dostum" — utanç mı, itiraf mı',
            acilis: '"Tek dostumsun" cümlesi ağzından çıktı. Charley\'nin yüzüne bakabildin mi?',
            sorular: ['Bu cümle Willy için ne — bir teşekkür mü, bir itiraf mı? Söylerken nereye baktı?'],
            catal: {
              anahtar: 's9-bosluk-dostum', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              secenekler: [
                { deger: 'tesekkur', baslik: 'Teşekkür', aciklama: 'Gerçekten minnet; tek kalan dost.',
                  muhur: 'Bunu unutma — kaybettiğim her şeyin ortasında, tek dostumu geç fark ettim.',
                  ozet: 'Tek dostumu kaybederken fark ettim.' },
                { deger: 'itiraf', baslik: 'İtiraf', aciklama: 'Bir yenilginin sessiz kabulü; gözüne bakamadım.',
                  muhur: 'Bunu unutma — "tek dostum" derken aslında ne kadar yalnız olduğumu itiraf ettim.',
                  ozet: 'O cümle yalnızlığımın itirafıydı.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Sigorta düşüncesi',
            acilis: 'Ofisten çıkarken zihninde bir şey kıpırdıyor — sigorta. Kendi ölümünün bir "satış" olabileceği düşüncesi belki ilk burada bedene yerleşir.',
            sorular: ['Sigorta düşüncesi zihnine geldiğinde Willy onu nasıl duydu — bir umut mu, bir karanlık mı?'],
            catal: {
              anahtar: 's9-bosluk-sigorta', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              secenekler: [
                { deger: 'umut', baslik: 'Umut', aciklama: 'Biff\'e bırakabileceğim bir şey; bir çıkış yolu.',
                  muhur: 'Bunu unutma — kendi ölümümü bir armağan gibi düşünmeye burada başladım.',
                  ozet: 'Ölümümü bir armağan gibi düşünmeye başladım.' },
                { deger: 'karanlik', baslik: 'Karanlık', aciklama: 'İçimi ürperten bir düşünce; ama kovamadım.',
                  muhur: 'Bunu unutma — o düşünce içimi ürpertti, yine de kovmadım.',
                  ozet: 'Ürperten düşünceyi kovmadım.' },
              ],
            },
          },
          {
            no: 3, zamanRozet: 'Ofisten çıkış',
            acilis: 'Boşluk kuruldu. Willy ofisten çıkıyor — cebinde para, zihninde tohum. Sahne 9\'a doğru.',
            sorular: ['Ofisten çıkarken Willy\'nin içinden geçen tek cümle ne olurdu?'],
            yazmaAlani: true, yazmaPlaceholder: 'Ofisten çıkarken içimden…',
          },
        ],
      },
    ...
    // ── no 4 · "Restoran tuvaletinde geçen süre" → S10 (mevcut) ──────────
    {
      ...
      yuruyus: {
        esik: {
          yogunlukUyarisi: 'Bu boşluk ağır. Willy lokantanın tuvaletinde yapayalnız, Boston yankısının içinde. Acelesi yok — bu bir yürüyüş, yeniden yaşamak değil. Bu anı bir adım dışarıdan kuracaksın. İstediğin an durabilirsin; yürüyüşün sonunda topraklanma var.',
          komut: 'Bu boşluğu bir adım dışarıdan kuracaksın. İçine düşmeyeceksin — tuvaleti, yankıyı, yalnızlığı bir yönetmen gibi kuracaksın. Acele yok.',
          adimlar: [
            'Önce anı kur: lokanta tuvaleti, oğullar gitti, Willy tek başına. Miller bu dakikaları yazmaz; sen kuracaksın.',
            'Willy\'yi dışarıdan gör — onun yerine geçme, sahneyi kur.',
            'Her durakta gerekirse dur, nefes al. Bu senin yürüyüşün; hızını sen belirlersin.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
          buton: 'Başlıyorum',
        },
        girisBaslik: 'Restoran tuvaletinde — boşluğu dışarıdan kur',
        girisAciklama: 'Biff gerçeği söylemeye çalıştı, Willy Boston belleğine düştü, oğullar onu bırakıp gitti. Willy tuvalete kaçtı. O en yalnız dakikaları Miller yazmaz; sen kuracaksın — bir adım dışarıdan.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; Sahne 10\'a hangi adam çıkıyor, bu boşluk belirler.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Boşluktan iki adım geri çekil. Tuvaleti, yankıyı, yalnızlığı arkanda bırak; uzun bir nefes ver, ayaklarını yere bas. Bu senin yalnızlığın değil — Willy\'nin verisi. Şimdiki ana dön; taşıdığını ama içinde olmadığını hisset.',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Tuvalette, tek başına',
            acilis: 'Lokantanın tuvaleti. Kapı kapandı. Willy tek başına — gürültü dışarıda, içeride sessizlik.',
            sorular: ['Tuvaletin içinde Willy\'nin bedeni ne yaptı — ayakta mı, çömelmiş mi, aynanın karşısında mı?'],
            yazmaAlani: true, yazmaPlaceholder: 'Tuvalette bedeni…',
          },
          {
            no: 1, zamanRozet: 'Boston yankısı',
            acilis: '"Sahtekârsın sen!" — Boston\'ın yankısı tuvalette geri geliyor. Şimdi ile geçmiş iç içe.',
            sorular: ['Geçmiş (Boston) ile şimdi (lokanta) Willy\'nin zihninde nasıl iç içe geçti — hangisi daha gerçek geldi?'],
            catal: {
              anahtar: 's10-bosluk-yanki', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Burada durmak istersen dur. Bu Willy\'nin yankısı — seninki değil. Bir nefes al, yere bas, hazır olduğunda devam et.',
              secenekler: [
                { deger: 'gecmis_baskin', baslik: 'Geçmiş baskın', aciklama: 'Boston şimdiden daha gerçek; oradayım sanki.',
                  muhur: 'Bunu unutma — en dayanılmaz anımda, geçmiş şimdiden daha gerçekti.',
                  ozet: 'Geçmiş şimdiden daha gerçekti.' },
                { deger: 'simdi_baskin', baslik: 'Şimdi baskın', aciklama: 'Yankı geçti; oğullarımın gittiğini fark ettim.',
                  muhur: 'Bunu unutma — yankı dindiğinde beni bekleyen şey, yalnızlığımdı.',
                  ozet: 'Yankı dinince yalnızlığım kaldı.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Terk edildiğini anlama',
            acilis: 'Bir an geliyor — oğullarının onu bırakıp gittiğini anlıyor. Yapayalnız.',
            sorular: ['Oğullarının onu bıraktığını ne zaman, nasıl anladı? O an içinde ne koptu?'],
            yazmaAlani: true, yazmaPlaceholder: 'Bırakıldığımı anladığım an…',
          },
          {
            no: 3, zamanRozet: 'Tuvaletten çıkış',
            acilis: 'Boşluk kuruldu. Willy tuvaletten çıkacak — ama eve giden uzun yol önünde. Sahne 10\'un eşiğindesin.',
            sorular: ['Tuvaletten çıkmadan önce, aynaya bakabildiyse ne gördü? Bakamadıysa neden?'],
            yazmaAlani: true, yazmaPlaceholder: 'Çıkmadan önce…',
          },
        ],
      },
    ...
    // ── no 11 · "Tek Başına — Eve Mi, Başka Yere Mi?" → S10 (eski b-7, SWAP önce, çapa 11→10) ──
    {
      ...
      yuruyus: {
        esik: {
          yogunlukUyarisi: 'Bu boşluk ağır. Willy gece sokakta, "gidiş"i bedeninde provalıyor — son arabanın habercisi. Acelesi yok — bu bir yürüyüş, yeniden yaşamak değil. Bu saatleri bir adım dışarıdan kuracaksın. İstediğin an durabilirsin; yürüyüşün sonunda topraklanma var.',
          komut: 'Bu boşluğu bir adım dışarıdan kuracaksın. İçine düşmeyeceksin — boş restoranı, gece sokağını, eve gitmeyen ayakları bir yönetmen gibi kuracaksın. Acele yok.',
          adimlar: [
            'Önce anı kur: oğullar gitti, restoran neredeyse boş, Willy sokağa çıkıyor — ama eve değil.',
            'Willy\'yi dışarıdan gör — onun yerine geçme, sahneyi kur.',
            'Her durakta gerekirse dur, nefes al. Bu senin yürüyüşün; hızını sen belirlersin.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
        ...
        girisBaslik: 'Tek başına — eve mi, başka yere mi — boşluğu dışarıdan kur',
        girisAciklama: 'Oğullar gitti. Willy sokağa çıktı ama ayakları eve gitmedi. Saat 11\'den geceyarısına uzayan o saatleri Miller yazmaz. Bu salınımı — eve mi, başka yere mi — sen kuracaksın, bir adım dışarıdan.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; bu salınım Sahne 11\'deki son arabanın habercisidir.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Boşluktan iki adım geri çekil. Gece sokağını, eve gitmeyen ayakları arkanda bırak; uzun bir nefes ver, ayaklarını yere bas. Bu senin gecen değil — Willy\'nin verisi. Şimdiki ana dön; taşıdığını ama içinde olmadığını hisset.',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Boş restoran',
            acilis: 'Neredeyse boş restoran. Hesap ödendi mi belirsiz. Willy ayağa kalkıyor, sokağa doğru.',
            sorular: ['Restorandan çıktığında saat kaçtı — o süre Willy\'ye uzun mu, bir anlık mı geldi?'],
            yazmaAlani: true, yazmaPlaceholder: 'Restorandan çıkarken…',
          },
          {
            no: 1, zamanRozet: 'Ayaklar eve gitmiyor',
            acilis: 'Sokaktasın. Linda evde bekliyor — bunu biliyorsun. Ama ayakların eve dönmüyor.',
            sorular: ['Bir yere oturdu mu — bir bank, bir köşe? Ayakları neden eve doğru gitmedi?'],
            catal: {
              anahtar: 's10-bosluk-eve', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Burada durmak istersen dur. Bu Willy\'nin salınımı — seninki değil. Bir nefes al, yere bas, hazır olduğunda devam et.',
              secenekler: [
                { deger: 'utanc', baslik: 'Eve gidemiyorum — utanç', aciklama: 'Linda\'nın yüzüne bakamam; bu halde değil.',
                  muhur: 'Bunu unutma — eve gidemememin nedeni yol değildi, yüzleşemediğim yüzdü.',
                  ozet: 'Eve gidemedim çünkü bir yüze bakamadım.' },
                { deger: 'gidis', baslik: 'Başka bir yere — gidiş', aciklama: 'Bir an, hiç dönmemeyi düşündüm.',
                  muhur: 'Bunu unutma — o gece sokakta, "gidiş"i bedenimde bir kez provaladım.',
                  ozet: 'O gece gidişi bedenimde provaladım.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Bekleyen Linda',
            acilis: 'Linda\'nın evde, uyumadan beklediğini biliyorsun. Bu bilgi seni nasıl etkiliyor?',
            sorular: ['Linda\'nın beklediği bilgisi Willy\'yi hızlandırdı mı, yoksa daha da mı yavaşlattı?'],
            yazmaAlani: true, yazmaPlaceholder: 'Linda\'nın beklediğini bilmek…',
          },
          {
            no: 3, zamanRozet: 'Sonunda eve',
            acilis: 'Boşluk kuruldu. Willy sonunda eve dönüyor — ama içinde "gidiş" provası kaldı. Sahne 10\'un eşiğinde, bahçeye doğru.',
            sorular: ['Eve dönmeye karar verdiği an, içinden geçen tek cümle ne olurdu?'],
            yazmaAlani: true, yazmaPlaceholder: 'Eve dönerken içimden…',
          },
        ],
      },
    ...
    // ── no 8 · "Geceyarısı Bahçesi" → S10 (eski b-4) ─────────────────────
    {
      ...
      yuruyus: {
        esik: {
          yogunlukUyarisi: 'Bu boşluk ağır — Willy\'nin kendisiyle baş başa kaldığı son sessiz saat. Acelesi yok; bu bir yürüyüş, yeniden yaşamak değil. Bu geceyi bir adım dışarıdan kuracaksın. İstediğin an durabilirsin; yürüyüşün sonunda topraklanma var.',
          komut: 'Bu boşluğu bir adım dışarıdan kuracaksın. İçine düşmeyeceksin — soğuk geceyi, kazılan toprağı, Ben\'le yarı sesli konuşmayı bir yönetmen gibi kuracaksın. Acele yok.',
          adimlar: [
            'Önce geceyi kur: aile yatıyor, Linda belli etmeden bekliyor, Willy bahçede. Miller bu sessiz saati yazmaz; sen kuracaksın.',
            'Willy\'yi dışarıdan gör — onun yerine geçme, sahneyi kur.',
            'Her durakta gerekirse dur, nefes al. Bu senin yürüyüşün; hızını sen belirlersin.',
          ],
          hitap: 'Hazır olduğunda ilk adımı at.',
        ...
        girisBaslik: 'Geceyarısı bahçesi — boşluğu dışarıdan kur',
        girisAciklama: 'Oğullar restoranda bıraktı; Willy eve döndü, Linda öfkeli. Willy bahçeye çıktı — soğuk gece, kazılan toprak, Ben\'le yarı sesli konuşma. Bir adamın kendisiyle baş başa kaldığı son sessiz saati sen kuracaksın.',
        girisSentez: 'Bu yürüyüşte seçtiklerin senin olur; Sahne 10\'daki Ben konuşmasının ve Biff yüzleşmesinin altındaki zemin budur.',
        gecisButonu: 'İlk durağa geç',
        cikisRitueli: 'Boşluktan iki adım geri çekil. Soğuk geceyi, toprağı, Ben\'in sesini arkanda bırak; uzun bir nefes ver, ayaklarını yere bas. Bu senin son gecen değil — Willy\'nin verisi. Şimdiki ana dön; taşıdığını ama içinde olmadığını hisset.',
        istasyonlar: [
          {
            no: 0, zamanRozet: 'Bahçeye çıkış',
            acilis: 'Aile yatıyor. Linda belli etmeden bekliyor. Willy bahçeye çıkıyor — soğuk gece, eline bir kürek.',
            sorular: ['Bahçeye çıkma kararını Willy nasıl verdi — ani bir kalkış mı, uzun süre düşünülmüş bir şey mi?'],
            yazmaAlani: true, yazmaPlaceholder: 'Bahçeye çıkma kararı…',
          },
          {
            no: 1, zamanRozet: 'Toprağı kazarken',
            acilis: 'Karanlıkta toprağı kazıyor, tohum ekiyor. Soğuk. Eller toprakta.',
            sorular: ['Toprağı kazarken elleri ne yapıyordu — aceleyle mi, özenle mi? Bu tohum bir umut mu, bir veda mı?'],
            catal: {
              anahtar: 's10-bosluk-tohum', dil: 'birinci_tekil',
              etiket: 'İki yol var. Hangisi senin?',
              guvenliCikis: true,
              topraklanmaNotu: 'Burada durmak istersen dur. Bu Willy\'nin gecesi — seninki değil. Bir nefes al, yere bas, hazır olduğunda devam et.',
              secenekler: [
                { deger: 'umut', baslik: 'Umut — bir şey büyütmek', aciklama: 'Karanlıkta da olsa bir şey büyüyebilir; hâlâ deniyorum.',
                  muhur: 'Bunu unutma — her şey biterken bile, toprağa bir umut ekmeyi denedim.',
                  ozet: 'Her şey biterken toprağa umut ektim.' },
                { deger: 'veda', baslik: 'Veda — son bir iş', aciklama: 'Bu tohumu görmeyeceğimi biliyordum; bir veda gibiydi.',
                  muhur: 'Bunu unutma — o tohumu, büyüdüğünü görmeyeceğimi bilerek ektim.',
                  ozet: 'Tohumu görmeyeceğimi bilerek ektim.' },
              ],
            },
          },
          {
            no: 2, zamanRozet: 'Ben\'le yarı sesli',
            acilis: 'Ben\'in sesi geceye karışıyor — "20 bin dolar garanti." Willy yarı sesli konuşuyor, kendisiyle ve hayaletle.',
            sorular: ['Ben\'le bu son konuşmada Willy gerçekten ikna mı oldu, yoksa kendini ikna mı etti?'],
            yazmaAlani: true, yazmaPlaceholder: 'Ben\'le konuşurken…',
          },
          {
            no: 3, zamanRozet: 'Son sessiz saat',
            acilis: 'Boşluk kuruldu. Bu, Willy\'nin kendisiyle baş başa kaldığı son gerçek saat. Birazdan Biff inecek, son yüzleşme başlayacak.',
            sorular: ['Bu sessiz saatin sonunda, kimsenin duymadığı tek bir cümle söyleyebilseydi — ne derdi?'],
            yazmaAlani: true, yazmaPlaceholder: 'Bu sessiz saatte içimden…',
          },
        ],
      },
