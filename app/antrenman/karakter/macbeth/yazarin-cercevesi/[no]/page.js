// app/antrenman/karakter/macbeth/yazarin-cercevesi/[no]/page.js
// ITC Actor's Gym — Modül II Macbeth · Yazarın Çerçevesi · Tek Tercih Detayı
//
...
export default function TercihDetaySayfasi({ params }) {
  ...
  const sa = ceviri(macbethI18n, dil).yazarinCercevesi.altSayfa;
  ...
  useEffect(() => {
    if (!yukleniyor && !tercih) {
      router.replace('/antrenman/karakter/macbeth/yazarin-cercevesi');
    }
    ...
    >
      ...
      >
        ...
        <HamletTercihSecim
          ...
          kokYol="/antrenman/karakter/macbeth"
        />
        ...
        >
          {oncekiNo ? (
            <a
              href={`/antrenman/karakter/macbeth/yazarin-cercevesi/${oncekiNo}`}
              style={navButonStili()}
          ...
          {sonrakiNo ? (
            <a
              href={`/antrenman/karakter/macbeth/yazarin-cercevesi/${sonrakiNo}`}
              style={navButonStili()}
              onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--ink)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = 'var(--ink-soft)'; }}
            >
            ...
            <a
              href="/antrenman/karakter/macbeth/yazarin-cercevesi/sentez"
              style={{
                ...navButonStili(),
                color: TON,
                borderColor: TON,
