// app/antrenman/karakter/macbeth/senin-cerceven/sentez/page.js
// ITC Actor's Gym — Modül II Macbeth · Senin Çerçeven · Sentez
//
...
export default function SeninCerceveSentez() {
  ...
  const ss = ceviri(macbethI18n, dil).seninCerceven.sentez;
    ...
    >
      ...
      >
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.9rem', flexWrap: 'wrap' }}>
                  ...
                  <a
                    href={`/antrenman/karakter/macbeth/senin-cerceven/${b.no}`}
                    style={{
                      marginLeft: 'auto',
        ...
        <HamletBolumGecisi
          ...
          oncekiYol="/antrenman/karakter/macbeth/senin-cerceven"
