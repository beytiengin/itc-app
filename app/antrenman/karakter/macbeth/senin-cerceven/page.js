// app/antrenman/karakter/macbeth/senin-cerceven/page.js
// ITC Actor's Gym — Modül II Macbeth · Senin Çerçeven (6 Boşluk)
//
// Shakespeare'in sustuğu 6 boşluk — oyuncu eş-yazar olarak doldurur.
// Chrome/didaktik metinler data/macbeth-i18n.js (seninCerceven) sözlüğünden;
// boşluk içeriği henüz macbeth.js (TR). Çift dilli (TR/EN).
...
export default function SeninCerceveAnaSayfa() {
  ...
  const sozluk = ceviri(macbethI18n, dil);
  ...
  useEffect(() => {
    async function yukle() {
      const veri = await altSoruYansimalariniGetir(macbeth.id);
      setYansimalar(veri);
      setYukleniyor(false);
    }
    yukle();
