  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#0a0a0a', color: '#f0ede8', display: 'flex', flexDirection: 'column' }}>
      ...
      <section style={{ flex: 1, padding: '3rem 2rem', maxWidth: '720px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
        ...
        {aktifSekme === 'bosluklar' && <BosluklarGorumu karakterId="macbeth" bosluklar={macbeth.bosluklar} kalibrasyon={kalibrasyon} />}
        {aktifSekme === 'egzersizler' && <EgzersizListesi karakterId="macbeth" egzersizler={macbeth.egzersizler} kalibrasyon={kalibrasyon} onEgzersizTamamlandi={egzersizTamamlandi} />}
