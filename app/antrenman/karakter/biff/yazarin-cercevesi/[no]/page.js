// app/antrenman/karakter/biff/yazarin-cercevesi/[no]/page.js
// ITC Actor's Gym — Modül II Biff · Yazarın Çerçevesi · Tek Tercih Detayı
//
...
export default function TercihDetaySayfasi({ params }) {
  ...
  const sa = ceviri(biffI18n, dil).yazarinCercevesi.altSayfa;
  ...
  useEffect(() => {
    if (!yukleniyor && !tercih) {
      router.replace('/antrenman/karakter/biff/yazarin-cercevesi');
    }
    ...
    >
      ...
      >
        ...
        <HamletTercihSecim
          ...
          karakterId={biff.id}
          kokYol="/antrenman/karakter/biff"
        />
        ...
        >
          {oncekiNo ? (
            <a
              href={`/antrenman/karakter/biff/yazarin-cercevesi/${oncekiNo}`}
              style={navButonStili()}
          ...
          {sonrakiNo ? (
            <a
              href={`/antrenman/karakter/biff/yazarin-cercevesi/${sonrakiNo}`}
              style={navButonStili()}
              onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--ink)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = 'var(--ink-soft)'; }}
            >
            ...
            <a
              href="/antrenman/karakter/biff/yazarin-cercevesi/sentez"
              style={{
                ...navButonStili(),
                color: TON,
                borderColor: TON,
