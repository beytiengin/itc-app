// app/antrenman/karakter/biff/senin-cerceven/sentez/page.js
// ITC Actor's Gym — Modül II Biff · Senin Çerçeven · Sentez
//
...
export default function SeninCerceveSentez() {
  ...
  const ss = ceviri(biffI18n, dil).seninCerceven.sentez;
    ...
    >
      ...
      >
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.9rem', flexWrap: 'wrap' }}>
                  ...
                  <a
                    href={`/antrenman/karakter/biff/senin-cerceven/${b.no}`}
                    style={{
                      marginLeft: 'auto',
        ...
        <HamletBolumGecisi
          ...
          oncekiYol="/antrenman/karakter/biff/senin-cerceven"
