// app/antrenman/karakter/biff/senin-cerceven/page.js
// ITC Actor's Gym — Modül II Biff · Senin Çerçeven (4 Boşluk)
//
// Miller'ın sustuğu 4 boşluk — oyuncu eş-yazar olarak doldurur.
// Chrome/didaktik metinler data/biff-i18n.js (seninCerceven) sözlüğünden;
// boşluk içeriği henüz biff.js (TR). Çift dilli (TR/EN).
...
export default function SeninCerceveAnaSayfa() {
  ...
  const sozluk = ceviri(biffI18n, dil);
  ...
  useEffect(() => {
    async function yukle() {
      const veri = await altSoruYansimalariniGetir(biff.id);
      setYansimalar(veri);
      setYukleniyor(false);
    }
    yukle();
