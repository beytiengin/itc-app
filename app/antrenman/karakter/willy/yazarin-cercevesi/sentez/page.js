                ...
                {yapilmis && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', paddingTop: '0.8rem', borderTop: '1px solid var(--bg-elevated)' }}>
                    ...
                    <textarea
                      ...
                      placeholder={dil === 'de' ? `In meinem Willy ${tercih.konu.toLowerCase()} ___, weil ___` : dil === 'en' ? `In my Willy, ${tercih.konu.toLowerCase()} ___, because ___` : `Benim Willy'mde ${tercih.konu.toLowerCase()} ___, çünkü ___`}
                      rows={3}
                      style={{
                        width: '100%',
