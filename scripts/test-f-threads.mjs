...
kopya('app/lib/coach-rapor-motor.js','coach-motor.mjs',(s)=>s.replace("'../../data/kalibrasyon/coach-rapor'","'./coach-rapor.mjs'").replace("'../../data/kalibrasyon/question-bank'","'./question-bank.mjs'").replace("'../../data/kalibrasyon/checkin-f'","'./checkin-f.mjs'").replace("import { modulBul } from './batarya-kaydet';","import { batarya } from './batarya.mjs';\nconst modulBul=(slug)=>batarya.moduller.find((m)=>m.slug===slug)??null;").replace("'./aps-rapor-motor'","'./aps-motor.mjs'").replace("'./core-rapor-motor'","'./core-motor.mjs'"));
